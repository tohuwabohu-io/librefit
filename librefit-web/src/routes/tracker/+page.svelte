						...
						<svelte:fragment slot="content">
							<div class="flex gap-4 justify-between">
								...
								<div class="flex flex-col grow gap-4">
									<TrackerInput category={'s'} />
									<TrackerInput disabled={true} value={300} category={'b'} />
									<TrackerInput disabled={true} value={200} category={'l'} />
									<TrackerInput disabled={true} value={700} category={'d'} />
								</div>
							</div>
						</svelte:fragment>
					</AccordionItem>
