...
<section class="variant-ghost-surface h-full flex">
    <div class="container mx-auto p-12 space-y-8 self-center">
        ...
        <p>
            Please read these terms of use ("terms of use", "agreement") carefully before using <a href="/" target="_blank">{url}</a>
        ...
        <p>
            ...
            you are advised to leave the website accordingly. We only grant use and access of this
        ...
        <p>
            Before you continue using our website, we advise you to read our privacy policy <a href="/imprint">{url}imprint</a>
        ...
        <p>
            ...
            us, its affiliates, directors, officers, employees, agents, suppliers, or licensors including all
            copyrights, trade secrets, trademarks, patents, and other intellectual property. You also agree
            that you will not reproduce or redistribute the our intellectual property in any way,
            including electronic, digital, or new trademark registrations.
        </p>
        <p>
            You grant us a royalty-free and non-exclusive license to display, use, copy, transmit, and
        ...
        <p>
            By visiting this website, you agree that the laws of Austria, without regard to principles of
        ...
        <p>
            You agree to indemnify us and our affiliates and hold us harmless against legal claims
        ...
        <p>
            We are not liable for any damages that may occur to you as a result of your misuse of our
            website.
        </p>
        <p>
            We reserve the right to edit, modify, and change this Agreement any time. We shall let our
            users know of these changes through electronic mail. This Agreement is an understanding
            between us and the user, and this supersedes and replaces all prior agreements regarding
