...
insert into calorie_tracker (user_id, added, sequence, category, amount) values ('2291b08c-7fb5-11ee-b962-0242ac120002', '2024-05-31', 1, 'l', 300);
insert into weight_tracker (user_id, added, sequence, amount) values ('2291b08c-7fb5-11ee-b962-0242ac120002', '2024-05-31', 1, 80);
insert into calorie_target(user_id, added, sequence, start_date, end_date, target_calories, maximum_calories) values ('2291b08c-7fb5-11ee-b962-0242ac120002', '2024-05-31', 1, '2024-01-01', '2024-12-31', 1900, 2400);
